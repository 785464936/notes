...
source_url: https://kaoyan.eol.cn/shiti/yingyu/201605/t20160512_1397152.shtml
author: T!gger.
created: 2026-08-14
project: "[[考研]]"
type: Exam
...
Happy people work differently. They're more productive, more creative, and willing to take greater risks. And new research suggests that happiness might influence ____1____ firm's work, too.
...
29. According to Ashe, the leading role in managing the species is in ____.  
...
（注：本题配图为饼图，标题为"某高校学生旅游目的调查"，各项占比：欣赏风景 37%、缓解压力 33%、广交朋友 9%、培养独立能力 6%、其他 15%。试卷原图为图片，此处以文字说明代替。）


[[考研英语真题答案-2016#Part B 参考范文|答案]]

%%
来源: 中国教育在线1397152(基准，分页_1–_10)＋社科赛斯1133＋研招网1516011217/1515280379＋华慧15859–15867＋kekenet 526632＋sohu 51225202(交叉核对)
核对: 正文与答案定案一致；完形1-20 C B D C D/B A D A B/A B A D C/D C C A B；阅读21-40 B D A C B/A C A D C/D B D A B/B C D D C；Part B 41-45 C E A B D
版本: Text2末段按kekenet补"industry groups and states generally argue it goes too far; environmentalists say it doesn't go far enough"(eol.cn同源缺)；Text4第5段按sohu补"tougher climb than earlier generations in reaching such signpost achievements as securing"；Text1¶3补第二个less(知乎长难句"意志力薄弱"佐证)；"lent red"多源保留(kekenet译文"增添红艳"，不改"lent color")；Part B选项序取文都式(万学版[C]/[D]互换)；答题卡统一写作ANSWER SHEET(eol.cn转载有1/2之别)
修正: conservations→conservation、range—wide→range-wide、landowner or→landowners or、44,00→44,000、ANWSER→ANSWER、sign you own→sign your own、27-yaear-old→27-year-old、pay ma→pay my、mark that happen→make that happen、their?children→their children、enfection→infection、aroud→around、by product→by-product、Q29句补"is"；"The web's full"及英式拼写(behaviours/maximised)保留
%%
